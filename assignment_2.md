...
### Άσκηση 17
Μία εταιρία φορτηγών κάνει διαδρομές μεταξύ διάφορων πόλεων. Οι πόλεις είναι κωδιποιημένες από το 0 μέχρι το Ν-1, όπου Ν είναι το πλήθος των πόλεων.
...
Σύμφωνα με το πίνακα η επόμενη πόλη είναι αυτή που βρίσκεται στη θέση 0, οπόται είναι η 5.
...
Όλα τα ζευγάρια κ,λ θετικών ακεραίων που είναι μικρότεροι ή ίσοι με το 10 όπου το λ διαρεί ακριβώς το κ είναι:
```
...
Η λίστα αυτή περιέχει τις σποστάσεις μεταξύ 10 πόλεων. 
