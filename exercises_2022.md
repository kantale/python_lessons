...
Αυτή η συνάρτηση (ίσως μπορείτε να τη κάνετε καλύτερη..) επιστρέφει το πλήθος των αγώνων που πρέπει να παιχτουν σε ένα τουρνουά, ώστε η πιθανότητα να κερδίσει το τουρνουά η Β δεδομένου να είναι μικρότερο από a. p είναι η πιθανότητα η Α να κερδίσει τη Β σε ένα οποιοδήποτε παιχνίδι. Για παράδειγμα:
...
2. Για κάθε a θα παίρνει όλες τις τιμές του `p` από 0.53 έως 0.65 με βήμα 0.005, θα υπολογίζει το αποτέλεσμα της `min_games` για τα τρέχων `p` και `a` . Μόλις τελειώσει ο υπολογισμός για όλα τα `p`, θα πλοτάρει στον Χ άξονα τις τιμές του p και στον Y τις τιμές της  `min_games`. Σαν χρώμα θα παίρνει τιμές από το colormap viridis με βάση τη τιμη της `a`. 
