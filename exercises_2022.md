...
* Θα πρέπει να φτιάξετε **ένα**  list comprehension το οποίο θα παράγει τη ζητούμενη λίστα. 
...
Φτοιάξτε μία συνάρτηση η οποία δεν θα παίρνει καμία παράμερτο. Η συνάρτηση θα επιστρέφει μία λίστα με όλες οι δυνατές ακολουθίες DNA που αποτελούνται από 5 νουκλεοτίδια και είναι παλινδρομικές. 
