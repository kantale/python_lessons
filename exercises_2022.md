...
### Άσκηση 42
Φτιάξτε μία συνάρτηση η οποία θα παίρνει σαν παράμετρο μία ακολουθία από ακέραιους αριθμούς (δεν χρειάζεται να το ελέγξετε αυτό). Η συνάρτηση θα επιστρέφει  τη θέση του αριθμού ο οποίος απέχει λιγότερο από τους γειτονικούς του. Δηλαδή αν η παράμετρος μας είναι η λίστα: α<sup>1</sup>, α<sup>2</sup>, ..., α<sup>i</sup>>, ... α<sup>n</sup>, τότε θα πρέπει να βρείτε τον αριθμό i τέτοιον ώστε η έκφραση |α<sup>i-1</sup>-α<sup>i</sup>|+|α<sup>i</sup>-α<sup>i+1</sup>| να είναι η μικρότερη για όλα τα δυνατά i. Προφανώς το i δεν μπορεί να είναι 0 ή n. Δίνεται ένα παράδειγμα:
...
To άθροισμα: |52-59| + |52-49| είναι 9 και το μικρότερο για όλες τις συνεχόμενες τριάδες του l. 
