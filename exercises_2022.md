...
* Για κάθε ζευγάρι να υπολογίζει την μεταξύ τους απόσταση.
...
Τα κλειδιά του dictionary `results` είναι τα ονόματα των υποψηφίων και τα κλειδιά οι επιδόσεις τους σε κάθε ένα από τα αθλήματα.
