...
### Άσκηση 41
Φτιάξτε μία συνάρτηση η οποία θα παίρνει σαν παράμετρο μία λίστα από strings (δεν χρειάζεται να το ελέγχετε αυτό). Η συνάρτηση θα επιτρέφει τη λίστα ταξινομημένη σύμφωνα με την.. αλαφαβητική ταξινόμηση του κάθε string της λίστας. Για παράδειγμα έστω η λίστα:
