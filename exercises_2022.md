...
Σημείωση: Εννοείται ότι το αρχείο `ask_58_create_file()` μπορεί να έχει περισσότερες από 3 γραμμές και περισσότερα από 3 γράμματα (όχι μόνο A,B,C).
...
Σημείωση: Εννοείται ότι το αρχείο `ask_59_create_file()` μπορεί να έχει περισσότερες από 3 γραμμές και περισσότερα από 3 γράμματα (όχι μόνο A,B,C).
